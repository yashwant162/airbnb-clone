...
export default function Perks({selected, onChange} ) {
  ...
  return (
        <>
          ...
          <label className="border p-4 flex gap-2 rounded-2xl items-center cursor-pointer">
            <input type="checkbox" checked = {selected.includes('Board Games')} name = 'Board Games' onChange={handleCbClick}/>
          ...
          <label className="border p-4 flex gap-2 rounded-2xl items-center cursor-pointer">
            <input type="checkbox" checked = {selected.includes('Music System')} name = 'Music System' onChange={handleCbClick}/>
